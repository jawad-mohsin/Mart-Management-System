 ...
 * @author HP
 */
public class Visiting extends javax.swing.JFrame {

    /**
     * Creates new form Visiting
     */
    public Visiting() {
        initComponents();
        SelectProduct();
    ...
    private void initComponents() {
        ...
        jLabel15.setFont(new java.awt.Font("Century Gothic", 1, 28)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(204, 0, 51));
        jLabel15.setText("VISITING STAFF POINT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Visiting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
